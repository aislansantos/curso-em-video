...
if reta1 < reta2 + reta3 and reta2 < reta1 + reta3 and reta3 < reta1 + reta2: 
    print('Com essas medida a condição de existencia de um triângulo É VERDADEIRA', end='')
    if reta1 == reta2 == reta3: # o python aceita fazer a comparação de igualdade de mais do que 2 condições dessa forma.
        print('esse é um triangulo EQUILATERO!')
    elif reta1 != reta2 != reta3 != reta1: # o python aceita fazer a comparação de igualdade de mais do que 2 condições dessa forma, na diferença devemos testar todas as condições
